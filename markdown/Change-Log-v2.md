...
## v2.0.6
This version is ported to NodeJS v24.x.x. Additionally, the project was moved
to the @neverending organization on 
[NPM](https://www.npmjs.com/package/@neverending/markugen).
